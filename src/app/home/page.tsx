...
export default function HomePage() {
  const featuredShoes = getFeaturedShoes(4);
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl md:text-4xl font-headline mb-6">
                The Legacy Leather Promise
              </h2>
              <p className="text-muted-foreground mb-8">
                Each pair of Legacy Leather shoes is more than just footwear; it's a testament to a rich heritage of craftsmanship. We use only the finest full-grain leathers and traditional techniques to create shoes that are built to last a lifetime.
              </p>
