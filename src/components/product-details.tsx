...
import { shoeSizes } from '@/lib/data';
...
export function ProductDetails({ shoe }: ProductDetailsProps) {
  ...
  const isCustomizationComplete = customization.shoeSize;
  ...
  const handleAddToCart = () => {
    if (!isCustomizationComplete) {
      toast({
        ...
        description: "Please select your shoe size.",
      });
      return;
    }
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="md:w-1/2">
              <Label htmlFor="shoe-size" className="text-base font-semibold">Select Shoe Size</Label>
              <Select
